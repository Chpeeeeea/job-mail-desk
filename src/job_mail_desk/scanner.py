...
from .state import StateStore, StateVersionMismatch
...
def _effective_lookback_days(
    ...
    *,
    ...
    """Return the configured window unless the caller explicitly overrides it."""

    del state, parser_changed
    return requested_days if requested_days is not None else settings.lookback_days
